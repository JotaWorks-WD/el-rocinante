...
?>
<h2 class="roci-section-title"><?php esc_html_e( 'Analytics', 'rocinante' ); ?></h2>
<table class="form-table">
    <tr>
        <th><label for="roci_ga_id"><?php esc_html_e( 'Google Analytics ID', 'rocinante' ); ?></label></th>
    ...
    <tr>
        <th><label for="roci_gtm_id"><?php esc_html_e( 'Google Tag Manager ID', 'rocinante' ); ?></label></th>
    ...
    <tr>
        <th><label for="roci_fb_pixel"><?php esc_html_e( 'Facebook Pixel ID', 'rocinante' ); ?></label></th>
...
<h2 class="roci-section-title"><?php esc_html_e( 'Custom Scripts', 'rocinante' ); ?></h2>
<p class="roci-note" style="margin-bottom:16px;"><?php esc_html_e( 'Use these fields for any third-party embed codes not covered above — booking systems, widgets, tracking pixels, iCal feeds, etc.', 'rocinante' ); ?></p>
<table class="form-table">
    <tr>
    ...
    <tr>
        <th><label for="roci_custom_footer"><?php esc_html_e( 'Custom Footer Script', 'rocinante' ); ?></label></th>
        <td>
